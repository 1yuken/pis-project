                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        '$score из ${index + 1} были правильными',
                        style: GoogleFonts.quicksand(
                          textStyle: TextStyle(
                              color: Colors.white,
                              fontSize: 18.sp,
...
Future<bool> _onBackPressed(BuildContext context) async {
  return showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      content: const Text('Хотите вернуться в раздел категорий?'),
      actions: <Widget>[
        TextButton(
          onPressed: () => Navigator.of(context).pop(false),
          child: const Text('Нет',style: TextStyle(color:Color(0xFFFF7A00))),
        ),
        TextButton(
          onPressed: () => Navigator.of(context).pop(true),
          child: const Text('Да',style: TextStyle(color:Color(0xFFFF7A00))),
        ),
      ],
    ),
